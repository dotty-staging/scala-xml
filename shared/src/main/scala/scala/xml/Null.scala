...
case object Null extends MetaData {
  ...
  def getNamespace(owner: Node): String | Null = null

  override def hasNext = false
  def next: MetaData = this
  def key: String = ""
  def value: Seq[Node] | Null = null
  ...
  def apply(namespace: String | Null, scope: NamespaceBinding, key: String): Seq[Node] | Null = null
